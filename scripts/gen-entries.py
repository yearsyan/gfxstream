...
def gen_functions_header(entries, prefix_name, verbatim, filename, with_args):
    ...
    print("// Copyright 2025 The Android Open Source Project")
    print("//")
    ...
    print("// WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either expresso or implied.")
