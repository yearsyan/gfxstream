...
// Auto-generated with: ./scripts/gen-entries.py --mode=funcargs host/gl/OpenGLESDispatch/gles_common.entries --output=host/gl/OpenGLESDispatch/include/OpenGLESDispatch/gles_common_functions.h
