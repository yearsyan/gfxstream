...
// Auto-generated with: ./scripts/gen-entries.py --mode=funcargs host/gl/OpenGLESDispatch/gles_extensions.entries --output=host/gl/OpenGLESDispatch/include/OpenGLESDispatch/gles_extensions_functions.h
