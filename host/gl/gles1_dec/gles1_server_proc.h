...
typedef GLenum (gles1_APIENTRY *glGetGraphicsResetStatusEXT_server_proc_t) ();
typedef void (gles1_APIENTRY *glReadnPixelsEXT_server_proc_t) (GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, GLsizei, GLvoid*);
